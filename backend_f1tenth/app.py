...
def analyze():
    """
    Full analysis pipeline: visual + audio + cross-reference to F1Tenth checklist.
...
def clarify():
    ...
    try:
        ...
        clarify_result = gemini.clarify_with_context(original_analysis, clarification_text, frames)
...
if __name__ == '__main__':
    print("=" * 50)
    print("  F1TENTH VISION-INSPECT API v0.2")
